    ...
    <main className="relative flex min-h-screen items-center justify-center overflow-hidden bg-black px-4">
      <div className="pointer-events-none absolute inset-0">
            ...
            <form className="space-y-4">
              <div>
                <input
                  ...
                  className="w-full rounded-x1 border border-white/10 bg-white/5 px-4 py-3 text-sm text-white outline-none placeholder:text-white/30 focus:border-white/20"
                />
              </div>
        ...
        <p className="mt-6 text-center text-xs text-white/35">
          By signing up, you agree to our Terms & Service.
        </p>
        </section>
        </main>
    );
